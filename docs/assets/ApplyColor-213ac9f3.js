import{c as u}from"./mat4-f2f89396.js";import{W as d,P as v,B as c,M as f,S as p,G as w}from"./webgl-bef542ad.js";import{r as C,o as b,b as g,a as h,c as x}from"./index-9023bf6a.js";const P={__name:"ApplyColor",setup(M){const a=C(null),l=()=>{const t=a.value,e=t.getBoundingClientRect(),o=u(e.width,e.height);return t.appendChild(o),{canvas:o,bounds:e}},m=t=>{const e=new w,o=new Float32Array([1,1,-1,1,1,-1]),n=new Float32Array([1,1,1,0,1,1,0,0,1]);e.setAttribute("aPosition",new c(o,2)),e.setAttribute("aColor",new c(n,3));const r=new f({geometry:e,shader:new p({vertex:`
