import{c as h}from"./mat4-f2f89396.js";import{W as y,T as d,P as M,B as v,M as b,S as U,G as V}from"./webgl-bef542ad.js";import{r as _,o as E,b as A,a as C,c as P}from"./index-21b15c9d.js";const T=""+new URL("gm-8dde0536.mp4",import.meta.url).href,k={__name:"TextureSource",setup(R){const i=_(null),f=()=>{const t=i.value,e=t.getBoundingClientRect(),n=h(e.width,e.height);return t.appendChild(n),{canvas:n,bounds:e}},p=()=>new Promise(t=>{let e=!1,n=!1;const r=document.createElement("video");r.muted=!0,r.crossOrigin="anonymous",r.loop=!0,r.preload="metadata",r.addEventListener("playing",()=>{e=!0,a()},!0),r.addEventListener("timeupdate",()=>{n=!0,a()},!0);const a=()=>{e&&n&&t(r)};r.src=T,r.play()}),x=()=>{const t=document.createElement("canvas");t.width=256,t.height=256;const e=t.getContext("2d");return e.fillStyle="#fff",e.rect(0,0,256,256),e.fill(),e.fillStyle="#000",e.fillText("Canvas纹理数据",100,100),t},c=(t,e)=>{const n=new V,r=new Float32Array([-1,1,-1,-1,1,-1,1,1]),a=new Uint16Array([0,1,2,2,3,0]),o=new Float32Array([0,0,0,1,1,1,1,0]);n.setAttribute("aPosition",new v(r,2)),n.setAttribute("aUV",new v(o,2)),n.setIndex(a);const s=new b({geometry:n,shader:new U({vertex:`
